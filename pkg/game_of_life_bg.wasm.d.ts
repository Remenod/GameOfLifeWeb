...
export const wasmgame_encode_field: (a: number, b: number) => [number, number];
export const wasmgame_decode_field: (a: number, b: number) => [number, number];
export const wasmgame_adapt_field_width: (a: number, b: number, c: number, d: number) => [number, number];
